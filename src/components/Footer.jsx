                    ...
                    <div className="mt-8 xl:mt-0">
                        ...
                        <div className="mt-4 sm:flex sm:max-w-md">
                            <div className="mt-3 rounded-md sm:mt-0 sm:flex-shrink-0">
                                <a
                                    href="https://github.com/TheInfamousGrim/notes-react-app/tree/main"
                                    className="flex w-full items-center justify-center rounded-md border border-transparent bg-secondary py-2 px-4 text-base font-medium text-white hover:bg-secondary-dark focus:outline-none focus:ring-2 focus:ring-secondary focus:ring-offset-2 focus:ring-offset-gray-800"
                                >
                                    GitHub Source Code
                                </a>
                            </div>
